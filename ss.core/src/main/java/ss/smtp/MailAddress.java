...
public class MailAddress implements java.io.Serializable {
	...
	/**
	 * <p>
	 * Construct a MailAddress parsing the provided <code>String</code>
	 * object.
	 * </p>
	 * 
	 * <p>
	...
	public String toString() {
		StringBuffer addressBuffer = new StringBuffer(128).append(this.user)
				.append("@").append(this.host);
	...
	private String parseDotNum(String address) throws ParseException {
		...
		for (int octet = 0; octet < 4; octet++) {
			...
			if (address.charAt(this.pos) == ']') {
				if (octet < 3) {
					throw new ParseException(
							"End of number reached too quickly at "
									+ (this.pos + 1));
				} else {
					break;
				}
