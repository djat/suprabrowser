...
public class EntryPoint {
	...
	public static void main(String[] args) {
		...
		try {
			...
			message.append(	StringUtils.getLineSeparator() ).append(ex.getMessage());
			message.append(	StringUtils.getLineSeparator() ).append("Trace: ");
			for ( StackTraceElement elem : ex.getStackTrace() ) {
				message.append(	StringUtils.getLineSeparator() ).append( elem.toString() );
			}
